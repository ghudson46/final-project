...
var Auth0Provider = function (opts) {
    ...
    var client = useState(function () { return new bo(toAuth0ClientOptions(clientOpts)); })[0];
    ...
    return (React.createElement(Auth0Context.Provider, { value: __assign(__assign({}, state), { getAccessTokenSilently: getAccessTokenSilently,
