    ...
    isSentByCurrentUser
      ? (
        <div className="messageContainer" style={{display: 'flex', justifyContent: 'flex-start', borderRadius: '2rem', paddingLeft: '2rem', margin: '1rem', width: '75%', float: 'left', textAlign: 'left'}}>
          ...
          <div className="messageBox" style={{backgroundColor: '#31e89f', padding: '0 2rem 0 .5rem', borderRadius: '2rem'}}>
        ...
        (
          ...
          <div style={{display: 'flex', flexDirection: 'column', padding: '0', margin: '0'}}>
            <p style={{marginBottom: '-.5rem', fontSize: '1rem', float: 'right'}}>{user}</p>
            <div className="messageBox" style={{backgroundColor: '#31e8e8', padding: '.1rem 2rem .1rem 1rem', borderRadius: '2rem'}}>
            ...
            {user !== 'admin' && <div style={{backgroundColor: '#31e89f', padding: '.3rem .5rem 0 .5rem', fontWeight: '600', borderRadius: '50%', height: '2.5rem', width: '2.5rem', marginTop: '.6rem', marginRight: '-1.5rem', marginLeft: '1rem', marginTop: '3.5rem'}}>{user.charAt(0).toUpperCase()}</div>}
