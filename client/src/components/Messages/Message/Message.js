      ...
      ? (
        ...
        (
          ...
          <div style={{display: 'flex', flexDirection: 'column', padding: '0', margin: '0'}}>
            <p style={{marginBottom: '-.5rem', fontSize: '1rem', position: 'relative', right: '-20%'}}>{capitalName}</p>
            ...
            {user !== 'admin' && <div style={{backgroundColor: '#31e89f', color: 'white', padding: '.3rem .5rem 0 .5rem', fontWeight: '600', borderRadius: '50%', height: '2.5rem', width: '2.5rem', marginRight: '-1.5rem', marginLeft: '1rem', marginTop: '2rem'}}>{user.charAt(0).toUpperCase()}</div>}
